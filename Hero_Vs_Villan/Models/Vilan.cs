...
namespace Hero_Vs_Villan.Models
{
    ...
    {
        public Vilan() { }
        public Vilan(int id,string name, int health, int ability, int strenght, int superPower, double totalImpact) : base(id,name, health, ability, strenght, superPower, totalImpact)
        { }
